...
namespace studenrecordsystem
{
    ...
    class AdressOperations
    {
        public static bool AddAlternativeAddresses(string Id)
        {
            ...
            {
                SqlOperations.InsertAdress(GetAdress(), Id);
                return true;
            }
        }
        ...
        {
            AdressClass adressToUpdate = new AdressClass();
            adressToUpdate = GetAdress();

            SqlOperations.UpdateAdress(adressToUpdate, studentIdToUpdate, adressNoToUpdate);
        }

        public static AdressClass GetAdress()
        {
